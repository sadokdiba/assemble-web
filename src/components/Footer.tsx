    ...
    <footer className="bg-surface-950 border-t border-surface-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#download" className="text-surface-400 hover:text-primary-400 transition-colors">Join Waitlist</a></li>
              <li><a href="https://github.com/sadokdiba" target="_blank" rel="noopener noreferrer" className="text-surface-400 hover:text-primary-400 transition-colors">Roadmap</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto:hello@assembleapp.org" className="text-surface-400 hover:text-primary-400 transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-surface-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <a 
            href="https://github.com/sadokdiba" 
            target="_blank" 
